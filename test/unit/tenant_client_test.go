...
// Stub to satisfy compilation — remove when real method exists
func (tc *client.TenantClient) FilterSpecByFeatureFlags(spec interface{}) interface{} {
  return tc.filterSpecByFeatureFlags(spec)
}
