// test/unit/commands/priorityclasses_test.go
...
func TestPriorityClassesCommand(t *testing.T) {
	...
	cmd := tenant.NewListPriorityClassesCmd()
	...
	assert.Contains(t, output, "Allowed Pod Priority Classes:")
