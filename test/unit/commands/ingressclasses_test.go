// test/unit/commands/ingressclasses_test.go
...
func TestIngressClassesCommand(t *testing.T) {
		...
		Object: map[string]interface{}{
			...
			"spec": map[string]interface{}{
				"ingressClasses": map[string]interface{}{
					"allowed": []interface{}{"nginx", "trafeik"},
				},
			},
		},
	}
	...
	cmd := tenant.NewListIngressClassesCmd()
	...
	assert.Contains(t, output, "Allowed Ingress Classes:")
	assert.Contains(t, output, "- nginx")
	assert.Contains(t, output, "- trafeik")
}
